...
class CDecoder_AMR_NB: public CDecoder_AMRInterface
{
    public:
        ...
        OSCL_IMPORT_REF virtual ~CDecoder_AMR_NB();
				...
				// partially initializes pExt. written members:
				// pInputBuffer
				// pOutputBuffer
				// samplingRate
				// desiredChannels
        ...
        OSCL_IMPORT_REF virtual int32 StartL(tPVAmrDecoderExternal * pExt,
				...
				// requires members of pExt to be set. those not properly set by StartL:
				// input_format
				// frame_type
				// pInputBuffer (if !aAllocateInputBuffer)
				// pOutputBuffer (if !aAllocateOutputBuffer)
