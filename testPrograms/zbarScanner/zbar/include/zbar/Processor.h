...
class Processor {
 public:
               ...
               bool enable_display = true)
    {
        ...
        if(!_processor)
            //throw std::bad_alloc();
            maPanic(0, "Couldn't allocate processor in Processor::Processor");
               ...
               bool enable_display = true)
    {
        if(zbar_processor_init(_processor, video_device, enable_display))
            ...
            maPanic(0, "zbar no processor in Processor::init");
    }
    ...
    bool is_visible ()
    {
        ...
        if(rc < 0)
            //throw_exception(_processor);
            maPanic(0, "zbar no processor in Processor::is_visible");
        return(rc != 0);
    }
    ...
    void set_visible (bool visible = true)
    {
        if(zbar_processor_set_visible(_processor, visible) < 0)
            //throw_exception(_processor);
            maPanic(0, "zbar no processor in Processor::set_visible");
    }
    ...
    void set_active (bool active = true)
    {
        if(zbar_processor_set_active(_processor, active) < 0)
            //throw_exception(_processor);
            maPanic(0, "zbar no processor in Processor::");
    }
