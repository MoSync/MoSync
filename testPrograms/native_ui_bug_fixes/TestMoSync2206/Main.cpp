 ...
 *
 * Test Edit box events.
 * First screen contains multiple edit boxes.
 * Second screen contains only one single line edit box.
 * Third screen contains only one multine line edit box.
 *
 */
