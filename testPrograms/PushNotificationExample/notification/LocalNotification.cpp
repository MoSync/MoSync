...
namespace Notification
{
    ...
    {
        int resultCode = maNotificationSetProperty(
            mHandle,
            property.c_str(),
            value.c_str());
        return resultCode;
    ...
    {
        char buffer[BUF_SIZE];
        resultCode = maNotificationGetProperty(
            mHandle,
            property.c_str(),
            buffer,
            BUF_SIZE);
    ...
    {
        this->setPropertyInt(MA_NOTIFICATION_BADGE_NUMBER, badgeNumber);
    }
    ...
    {
        return getPropertyInt(MA_NOTIFICATION_BADGE_NUMBER);
    }
    ...
    {
        this->setProperty(MA_NOTIFICATION_CONTENT_BODY, text);
    }
    ...
    {
        return this->getPropertyString(MA_NOTIFICATION_CONTENT_BODY);
    }
    ...
    {
        this->setProperty(MA_NOTIFICATION_ALERT_ACTION, alertAction);
    }
    ...
    {
        return this->getPropertyString(MA_NOTIFICATION_ALERT_ACTION);
    }
    ...
    void LocalNotification::setPlaySound(bool playSound)
    {
        ...
        this->setProperty(MA_NOTIFICATION_PLAY_SOUND, value);
    }
    ...
    {
        MAUtil::String value =
            this->getPropertyString(MA_NOTIFICATION_PLAY_SOUND);
    ...
    void LocalNotification::setFireDate(struct tm* time)
    {
        ...
        this->setPropertyInt(MA_NOTIFICATION_FIRE_DATE, dateMillisec);
    }
    ...
    struct tm LocalNotification::getFireDate() const
    {
        int minDateMilliseconds =
            this->getPropertyInt(MA_NOTIFICATION_FIRE_DATE);
         tm timeStruct;
