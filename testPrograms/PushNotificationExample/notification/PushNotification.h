...
namespace Notification
{
     ...
     * user. Check what contains a notification by calling containsAlertMessage(),
    ...
    public:
         ...
         * false otherwise.
         */
        virtual bool containsAlertMessage() const;
         ...
         */
        virtual MAUtil::String getAlertMessage() const;
    ...
    protected:
         ...
         */
        virtual void setAlertMessage(const MAUtil::String& alertMessage);
