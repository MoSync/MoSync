...
public:
	/**
	 * Function that fills the Set all the permissions that we can ask from
	 * Facebook.
	 * @param permissions - will contain all the permissions that we can ask
	 * from Facebook.
	 */
...
/**
 * \brief Template class used for retrieving the extra permissions
 * (the permissions needed besides the access_token )
 * Those permissions are needed for certain connections or to publish on
 * Facebook.
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Album object.
 */
template<>
...
public:
	/**
	 * Adds to the "permissions" Set all permissions needed to make any type
	 * of request on an Album object.
	 */
	...
	/**
	 * Adds to the "permissions" set all permissions needed to ask for
	 * connections.
	 */
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on an
	 * Album object.
	 */
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Checkin object.
 */
template<>
...
public:
	/**
	 * Adds to the "permissions" set all permissions needed to make any type of
	 * request on a Checkin object.
	 */
	static void allPosibleRequests(MAUtil::Set<MAUtil::String> &permissions)
	{
		permissions.insert("user_checkins");
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a
	 * Checkin object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Comment object.
 */
template<>
...
public:
	...
	/**
	 * No extra permissions needed to retrieve a connection from a Comment
	 * object.
	 */
	static void retrievingData(MAUtil::Set<MAUtil::String> &permissions)
	{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Event object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Event
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
	...
	struct Publish
	{
		...
		/**
		 * Adds to the "permissions" set the permission needed publish on an
		 * Event's wall.
		 */
		...
		/**
		 * Adds to the "permissions" set the permission needed to response to
		 * an event.
		 */
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a FriendList object.
 */
template<>
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Group object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Group
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Link object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Link
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Note object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Note
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Photo object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Photo
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
 ...
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Post object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Post
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a StatusMessage object.
 */
template<>
...
public:
	/**
	 * Adds to the "permissions" set all permissions needed to make any type of
	 * request on a StatusMessage object.
	 */
	static void allPosibleRequests(MAUtil::Set<MAUtil::String> &permissions)
	{
		permissions.insert("publish_stream");
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a User object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a User
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
	 ...
	 */
		...
		{
			/**
			 * Adds to the "permissions" set the permission needed to to
			 * retrieve the "languages" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to to
			 * retrieve the "bio" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to to
			 * retrieve the "birthday" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to to
			 * retrieve the "education" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to to
			 * retrieve the "hometown" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "interested_in" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "favorite_teams" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "favorite_athletes" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "quotes" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "relationship_status" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "religion" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "significant_other" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "website" field of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "work" field of an User object.
			 */
		...
		{
			/**
			 * Adds to the "accounts" set the permission needed to
			 * retrieve the "activities" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "albums" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "books" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "checkins" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "events" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "family" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "feed" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "games" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "groups" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "home" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "interests" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "likes" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "links" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "movies" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "music" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "notes" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "photos" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "statuses" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "tagged" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "television" connection of an User object.
			 */
			...
			/**
			 * Adds to the "permissions" set the permission needed to
			 * retrieve the "videos" connection of an User object.
			 */
	...
	{
		/**
		 * Adds to the "permissions" set the permission needed to publish an
		 * album.
		 */
		...
		/**
		 * Adds to the "permissions" set the permission needed to to publish a
		 * checkin.
		 */
		...
		/**
		 * Adds to the "permissions" set the permission needed to publish a
		 * friendList.
		 */
		...
		/**
		 * Adds to the "permissions" set the permission needed needed to
		 * publish on wall.
		 */
		static void onWall(MAUtil::Set<MAUtil::String> &permissions)
		{
...
/**
 * \brief Template class for retrieving the permissions needed for a connection
 * or to make a publish request on a Video object.
 */
template<>
...
public:
	...
	/**
	 * Adds to the "permissions" set all permissions needed publish on a Video
	 * object.
	 */
	static void publishingData(MAUtil::Set<MAUtil::String> &permissions)
	{
