...
namespace NativeUI
{
	 ...
	 */
	void HorizontalLayout::setChildVerticalAlignment(const MAUtil::String alignment)
	{
		setProperty(
	 ...
	 */
	void HorizontalLayout::setChildHorizontalAlignment(const MAUtil::String alignment)
	{
		setProperty(
