...
"     --android-package <pkg>          Android package name (need to be unique for Android Market).\n"
"     --android-version-code <version> Android version code (used in androidmanifest.xml).\n"
"     --android-keystore <file>        Keystore for signing (Android only).\n"
"     --android-storepass <password>   Keystore password (Android only).\n"
"     --android-alias <alias>          Key alias (Android only).\n"
"     --android-keypass <password>     Key password (Android only).\n"
