...
This example shows how to use various native wwidgets (UI
...
In the UIWrapper folder is a class library that illustrates
how to wrap the low-level widget API in a higher-level, object
oriented framework, which simplifies UI development.

You can use this library in your own applications, and extend it
as needed, but note that this is an example library, and is not
fully documented and does not fully support all features of the
NativeUI Widget API.
...
* Use of a single code base with slightly different UIs
  ...
  See for example method WidgetManager::isAndroid() and
