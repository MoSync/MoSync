 ...
 * Constructor.
 */
JSONMessageHandler::JSONMessageHandler(NativeUI::WebView* webView) :
	mWebView(webView),
 ...
 */
void JSONMessageHandler::initializePhoneGap()
{
 ...
 */
bool JSONMessageHandler::handlePhoneGapMessage(JSONMessage& message)
{

	lprintfln("@@@ MOSYNC: Message service: %s action: %s",
 ...
 * message to PhoneGap.
 */
void JSONMessageHandler::processKeyEvent(int keyCode, int nativeKeyCode)
{
	if (MAK_BACK == keyCode)
	{
...
void JSONMessageHandler::sendConnectionType(MAUtil::String callbackID)
{
 ...
 */
void JSONMessageHandler::sendDeviceProperties(MAUtil::String callbackID)
{
	char deviceName[256];
	char deviceUUID[256];
	char deviceOS[256];
 ...
 */
void JSONMessageHandler::enableHardware()
{
 ...
 */
void JSONMessageHandler::customEvent(const MAEvent& event)
{
 ...
 */
void JSONMessageHandler::sensorEvent(MASensor sensorData)
{
 ...
 */
void JSONMessageHandler::callSuccess(
 ...
 * @param keepCallback true if this callback should be kept by PhoneGap.
 */
void JSONMessageHandler::callError(
	const String& callbackID,
 ...
 * will convert the JSON args to a JS object.
 */
void JSONMessageHandler::callCallback(
 ...
 */
void JSONMessageHandler::callJS(const String& script)
{
	mWebView->callJS(script);
}
 ...
 */
void JSONMessageHandler::setSensorEventTarget(int sensor, bool toSensorManager)
{
