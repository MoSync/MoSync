...
/**
 * The addresses of the servers where to send the push notification token.
 */
#define IOS_SERVER_IP "192.168.1.100"
#define IOS_SERVER_PORT 4567
#define ANDROID_SERVER_IP "192.168.1.111"
#define ANDROID_SERVER_PORT 6789
