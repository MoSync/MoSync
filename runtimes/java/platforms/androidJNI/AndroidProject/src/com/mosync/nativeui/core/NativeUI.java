...
public class NativeUI
{
	...
	// {
	// Log.e( "@@MoSync",
	// "maActionBarAddMenuItem: Invalid screen widget handle: "
	// + handle );
	// return IX_WIDGET.MAW_RES_INVALID_HANDLE;
	// }
	//
	...
	//
	// Log.e("@@MoSync",
	// "ActionBar feature cannot be applied. Action bar is disabled.");
	...
	// * @return
	// */
	// public int maActionBarRemoveItem(final int screenHandle, final int
	// itemHandle)
	// {
	// if (! MoSync.checkActionBarCompatibility())
	// return IX_WIDGET.MAW_RES_ACTION_BAR_NOT_AVAILABLE;
	...
	// if( icon != null )
	// {
	// m_activity.getActionBar().setBackgroundDrawable(new
	// BitmapDrawable(icon));
	// return IX_WIDGET.MAW_RES_OK;
	// }
	// }
