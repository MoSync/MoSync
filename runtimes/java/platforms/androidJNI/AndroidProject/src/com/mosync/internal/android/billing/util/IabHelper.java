...
public class IabHelper {
    ...
    // The response code from isBillingSupported request issuedright after the service is connected.
    int mCheckSupportedResponse = BILLING_RESPONSE_RESULT_BILLING_UNAVAILABLE;
    ...
    public void setSignature(String base64PublicKey)
    {
		mSignatureBase64 = base64PublicKey;
    }
        ...
        mServiceConn = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                try {
                    ...
                    mCheckSupportedResponse = mService.isBillingSupported( BILLING_API_VERSION, packageName, ITEM_TYPE_INAPP);
                    if (mCheckSupportedResponse != BILLING_RESPONSE_RESULT_OK) {
                        if (listener != null) listener.onIabSetupFinished(
								new IabResult(mCheckSupportedResponse,
    ...
    /**
     * Get the response code from the isBillingSupported request issued
     * right after the service is connected.
     * @return The response code.
     */
    public int getBillingSupportedResponse()
    {
		return mCheckSupportedResponse;
    }
    ...
    /**
     * get the current request code to match it with onActivityResult request code.
     * @return
     */
    ...
    public boolean handleActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == Activity.RESULT_OK && responseCode == BILLING_RESPONSE_RESULT_OK) {
            ...
            result = new IabResult(IABHELPER_UNKNOWN_PURCHASE_RESPONSE, "Unknown purchase response.", requestCode);
            if (mPurchaseListener != null) mPurchaseListener.onIabPurchaseFinished(result, null);
        }
        return true;
    }
