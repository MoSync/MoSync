...
#include "PimEventItem.h"
#include "PimUtil.h"
#import "PimList.h"

@interface PimEventsList :  PimList {
    /**
     * Stores the event items imported from calendar or
     * created by user.
     */
    NSMutableDictionary* mEventsDictionary;
    
    /**
     * Reference to an object used to interact with the calendar database.
     */
    EKEventStore* mEventStore;
    
    /**
     * The current item index in key array(generated by mEventsDictionary).
     */
    int mKeysArrayIndex;
}
